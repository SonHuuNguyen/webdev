...
<html>
<head>
	<title>News|Admin|<?php echo $__env->yieldContent('title'); ?></title>
  <meta charset="utf-8">
 ...
 <nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="<?php echo e(route('posts.create')); ?>"><span class="glyphicon glyphicon-plus"></span> Add new</a></li>
      <li><a href="#"></a></li>
    </ul>
...
<div class="container-fluid" style="margin-top: 50px;">
	<div class="row" id="main">
		<div class="col-md-2 col-sm-2 col-xs-12" id="left_menu">
			<table>
				...
				<tr>
					...
					<td class='<?php echo e(Request::is('*posts') ? "dsb_active" : ''); ?>'><a href="<?php echo e(route('posts.index')); ?>"><h5>All posts</h5></a></td>
		...
		<strong>Dashboard </strong><?php echo $__env->yieldContent('item'); ?>
		</div>
