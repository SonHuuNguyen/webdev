...
<div class="row">
	<div class="col-md-10 col-sm-10 col-xs-12" id="new_form">
	  <form method="post" action="<?php echo e(route('posts.update', $post->id)); ?>" accept-charset="UTF-8">
	   <?php echo e(csrf_field()); ?>

        <div class="form-group">
		    <label for="title">Post title:</label>
		    <input type="input" class="form-control" id="title" name="title" value="<?php echo e($post->title); ?>">
		</div>
		<div class="form-group">
	    ...
	    <div class="form-group">
		  ...
		  <textarea class="form-control editor" rows="10" id="edit" name="content"><?php echo e($post->content); ?></textarea>
		  <br>
		  <label for="preview">Preview your post:</label>
		  <pre id="preview"></pre>

		  <button type="submit" class="btn btn-default">Save change</button>
		  <input type="hidden" name="_token" value="<?php echo e(Session::token()); ?>"> <?php echo e(method_field('PUT')); ?>
